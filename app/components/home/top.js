...
function TopController($rootScope, $state, $stateParams, $scope, $filter, $translate, $interval, messageBox, myDashService) {
    ...
    function makePushSession() {
        if ( !pushCnct ) {
            ...
            pushCnct =
            // new PnsClient('https://bizservice.iotmakers.kt.com/stomp', 'https://bizservice.iotmakers.kt.com/pushapi/v1/sessions', mbrSeq, 'gqdmd4c8pwm1BqAJ', scpt);
            ...
            pushCnct.setUsername("iotmakers");
            pushCnct.setPassword("iotmakers");
